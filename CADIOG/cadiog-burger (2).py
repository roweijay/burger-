...
class BurgerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Cadiog Burger")
        self.root.geometry("800x600")
        self.canvas = tk.Canvas(root, width=800, height=600, bg='white')
        self.canvas.pack(fill="both", expand=True)
        self.obj_size = 220
        self.name_text = "Roweijay Cadiog"
    ...
    def create_widgets(self):
        ...
        self.canvas.create_text(400, 50, text="Welcome to Cadiog's Burger!", font=("Arial", 24), fill="darkgreen")
